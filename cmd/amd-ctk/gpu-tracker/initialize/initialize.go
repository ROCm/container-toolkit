...
func AddNewCommand() *cli.Command {
	// Add the gpu-tracker init command
	gpuTrackerInitCmd := cli.Command{
		Name:      "init",
		Hidden:    true,
		Usage:     "Initalize the GPU Tracker",
		UsageText: "amd-ctk gpu-tracker init [options]",
